...
const useStyles = makeStyles(theme => ({
  ...
  featureItems: {
    width: '100%',
    height: '100%',
    background: 'url(/images/illustrations/bg-shapes.svg) no-repeat top center',
  ...
  iconCover: {
    width: 60,
    height: 60,
    background: 'url(/images/illustrations/bgicon.svg) no-repeat center center',
    backgroundSize: 'contain',
    display: 'flex',
                        ...
                        <DescriptionListIcon
                          icon={
                            <div className={classes.iconCover}>
                              <i className={clsx(classes.icon, item.icon)} />
                            </div>
                          }
                          title={item.title}
